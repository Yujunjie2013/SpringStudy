...
public class EmailController {
    ...
    public String sendSimpleEmail() {
        try {
            ...
            message.setTo("819828037@qq.com"); // 接收地址
    ...
    public String sendHtmlEmail() {
        ...
        try {
            ...
            helper.setFrom(from);
            helper.setTo("819828037@qq.com"); // 接收地址
    ...
    public String sendAttachmentsMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("/Users/yujunjie/Desktop/接口调用样例.docx"));
    ...
    public String sendInlineMail() {
        ...
        try {
            ...
            // 传入附件 static/img/sunshine.png
            Resource resource = new ClassPathResource("./static/img/sunshine.png");
            helper.addInline("img", resource);//这里的img和src='cid:img'的img相对应
            jms.send(message);
            return "发送成功";
        } catch (Exception e) {
            e.printStackTrace();
